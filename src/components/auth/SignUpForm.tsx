    ...
    <div className="pt-16">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Tham gia cùng chúng tôi! Tạo tài khoản để bắt đầu hành trình của bạn.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              <Link href="/terms" className="font-medium text-brand-500 hover:text-brand-600 dark:text-brand-400 transition-colors hover:underline">
                Điều khoản sử dụng
              </Link>{" "}
              và{" "}
              <Link href="/privacy" className="font-medium text-brand-500 hover:text-brand-600 dark:text-brand-400 transition-colors hover:underline">
                Chính sách bảo mật
              </Link>{" "}
              của chúng tôi.
            </p>
